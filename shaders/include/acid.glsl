...
//	if (worldPosition.x >= 50.5) position.x = 50.0 - cameraPosition.x + position.x * 0.05;
	...
	intensity += 1.0 * sinpowsharp(clamp01(track, 9045.3, 9069.3 - 9045.3), 1.0);
	intensity -= 2.0 * sinpowsharp(clamp01(track, 9062.3, 9114.3 - 9062.3), 1.0);
	...
	intensity -= 1.0 * sinpowsharp(clamp01(track, 9424.3, 9476.3 - 9424.3), 1.0);
	...
	intensity -= 2.0 * sinpowsharp(clamp01(track, 10152.3, 10204.3 - 10152.3), 1.0);
	intensity += 1.0 * sinpowfast	(clamp01(track, 10314.3, 35.0), 2.0);
