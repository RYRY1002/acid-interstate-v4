...
deformationController -= 1.0 * sinpowfast(clamp01(track, 2283.5, 492.5), 3.0);
...
deformationController -= 1.0 * sinpowfast(clamp01(track, 20503.5, 250.5), 3.0);
...
customDeformationP1  = 1.0 * sinpowfast(clamp01(track, 2283.5, 492.5), 3.0);
...
customDeformationP3  = 1.0 * sinpowfast(clamp01(track, 10314.5, 615.5), 3.0);
customDeformationP3 -= 1.0 * sinpowslow(clamp01(track, 12930.5, 257.5), 3.0);
...
customDeformationP4  = 1.0 * sinpowsmooth(clamp01(track, 13207.5, 492.5), 3.0);
customDeformationP4 -= 1.0 * sinpowsmooth(clamp01(track, 14675.5, 820.5), 3.0);
position.y += -3.25 * customDeformationP4;
rotate(position.zy, position.x * customDeformationP4 * 0.05);
position.y -= -3.25 * customDeformationP4;

// P5 Custom Deformation
float customDeformationP5 = 0.0;
customDeformationP5  = 1.0 * sinpowfast(clamp01(track, 20503.5, 250.5), 3.0);
...
rotate(position.zy, abs(position.z) / 75.0 * customDeformationP5);
