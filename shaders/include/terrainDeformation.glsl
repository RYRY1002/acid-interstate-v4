...
deformationController -= 1.0 * sinpowfast(clamp01(track, 20503.5, 100.5), 3.0);
deformationController += 1.0 * sinpowfast(clamp01(track, 21827.0, 22319.5), 3.0);
...
customDeformationP1  = 1.0 * sinpowfast(clamp01(track, 2283.5, 246.5), 3.0);
